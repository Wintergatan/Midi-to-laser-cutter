...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _instrumentMaps = __webpack_require__(11);
	
	var MidiConvert = {
		instrumentByPatchID: _instrumentMaps.instrumentByPatchID,
		instrumentFamilyByID: _instrumentMaps.instrumentFamilyByID,
		drumKitByPatchID: _instrumentMaps.drumKitByPatchID,
	  ...
	  */
		fromJSON: function fromJSON(json) {
			return _Midi.Midi.fromJSON(json);
		}
	};
	   ...
	   */
			value: function fromJSON(json) {
				...
				json.tracks.forEach(function (track) {
					var newTrack = _Track.Track.fromJSON(track);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BinaryInsert = __webpack_require__(7);
			...
			value: function fromJSON(json) {
				...
				if (json.notes) {
					json.notes.forEach(function (note) {
						var newNote = _Note.Note.fromJSON(note);
...
/***/ (function(module, exports) {
	...
	var drumKitByPatchID = exports.drumKitByPatchID = {
		0: "standard kit",
		8: "room kit",
		16: "power kit",
		24: "electronic kit",
